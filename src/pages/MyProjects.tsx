  ...
  <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
    {loading ? (
        ...
        <div className='py-10 min-h-[80vh]'>
             <div className='py-20 w-full flex items-center justify-between mb-12'>
                <h1 className='text-2xl font-medium text-white'>My Projects</h1>
                <button onClick={()=> navigate('/')} className='flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br from-indigo-500
                to-indigo-600 hover:opacity-90 active:sclae-95 transition-all'>
                    <PlusIcon size={18}
                />
                    New Project
                </button>
